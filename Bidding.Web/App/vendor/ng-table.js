(function (angular, factory) {
        ...
        function ($compile, $q, $parse) {
            ...
            return {
                ...
                compile: function (element) {
                    ...
                    angular.forEach(row.children('td'), function (item) {
                    ...
                    return function (scope, element, attrs) {
                        ...
                        if (!element.hasClass('ng-table')) {
                            ...
                            if(element.parents('.table-responsive').length){
                                appendTo = element.parents('.table-responsive');
                            }
                            appendTo.after(paginationTemplate);
    ...
    angular.module('ngTable').run(['$templateCache', function ($templateCache) {
        $templateCache.put('ng-table/filters/select-multiple.html', '<select ng-options="data.id as data.title for data in column.data" multiple ng-multiple="true" ng-model="params.filter()[name]" ng-show="filter==\'select-multiple\'" class="filter filter-select-multiple form-control input-sm" name="{{column.filterName}}"> </select>');
        $templateCache.put('ng-table/filters/select.html', '<select ng-options="data.id as data.title for data in column.data" ng-model="params.filter()[name]" ng-show="filter==\'select\'" class="filter filter-select form-control input-sm" name="{{column.filterName}}"> </select>');
        $templateCache.put('ng-table/filters/text.html', '<input type="text" name="{{column.filterName}}" ng-model="params.filter()[name]" ng-if="filter==\'text\'" class="input-filter form-control input-sm"/>');
        $templateCache.put('ng-table/filters/date.html', '<input type="date" name="{{column.filterName}}" ng-model="params.filter()[name]" ng-if="filter==\'date\'" class="input-filter form-control input-sm"/>');
